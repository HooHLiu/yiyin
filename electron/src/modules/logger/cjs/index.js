...
Object.defineProperty(exports, 'setLoggerConfig', { enumerable: true, get() {
  return config_2.setLoggerConfig
} })
const logger_1 = require('./src/logger')

Object.defineProperty(exports, 'Logger', { enumerable: true, get() {
  return logger_1.Logger
} })
async function closeAllLogger() {
  if (config_1.task.id)
